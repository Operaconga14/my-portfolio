                        ...
                        <div key={index} className="col-md-6">
                            ...
                            >
                                <div className="position-relative">
                                    <Image src={project.image || "/placeholder.svg"} width={500} height={300} style={"card-img-top"} alt={project.title} />
                                    <div className="position-absolute top-0 start-0 w-100 h-100 bg-dark bg-opacity-50 d-flex align-items-center justify-content-center opacity-0 hover-opacity-100 transition-opacity">
                                        <div className="d-flex gap-2">
                                            ...
                                            >
                                                <Icon style={"fs-5"} name={"bi bi-github text-danger"} />
                                            </a>
                                            <a
                                                href={project.demo}
                                                className="btn btn-sm btn-light rounded-circle"
                                            ...
                                            >
                                                <ExternalLink url={project.demo} styles={[ { urlStyle: 'text-primary' }, { iconStyle: 'text-primary' } ]} text={""} iconName={"bi bi-github"} />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div className="card-body p-4">
                                    ...
                                    <div className="d-flex flex-wrap gap-2 mb-3">
                                        {project.tags.map( ( tag, tagIndex ) => (
                                            <span key={tagIndex} className="badge bg-primary bg-opacity-10 text-primary">
                                                {tag}
                                            </span>
                                        ) )}
                                    </div>
                                    <div className="d-flex justify-content-between">
                                        <a href={project.github} className="text-decoration-none d-flex align-items-center gap-1">
                                            <Icon name="bi bi-github" style="" />
                                            <span>Code</span>
                                        </a>
                                        <a href={project.demo} className="text-decoration-none d-flex align-items-center gap-1">
                                            <ExternalLink url={project.demo} styles={[ { urlStyle: 'text-primary' }, { iconStyle: 'text-primary' } ]} text={""} iconName={"bi bi-box-arrow-up-right"} />
                                            <span>Live Demo</span>
                                        </a>
                                    </div>
                                </div>
