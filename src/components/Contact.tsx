        ...
        <section id={`${id}`} className="py-5 bg-light">
            <div className="container py-5">
                <div className="text-center mb-5">
                    ...
                    <p className="lead text-muted">Let's discuss your project or just say hello</p>
                </div>
                    ...
                    <div className="col-lg-5 mb-4 mb-lg-0">
                        ...
                        >
                            ...
                            <div className="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <p className="fw-medium mb-0">Website</p>
                                    <p className="text-muted mb-0">https://amirejoseph.netlify.app</p>
                                </div>
                            </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    <p className="fw-medium mb-0">GitHub</p>
                                    <p className="text-muted mb-0">https://github.com/Operaconga14</p>
                                </div>
                            </div>
